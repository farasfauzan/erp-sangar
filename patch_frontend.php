        ...
        switch (roleId) {
            case 1: // LAPANGAN
                return [
                    ...
                    { name: 'Penerimaan Barang', route: 'dashboard', icon: '📦' },
                    { name: 'Input Opname', route: 'dashboard', icon: '🏗️' },
            ...
            case 3: // PURCHASING & LEGAL
                return [
                    ...
                    { name: 'Input Tagihan', route: 'dashboard', icon: '📥' },
                ];
            ...
            case 5: // MGR_KOMERSIAL
                return [
                    ...
                    { name: 'Approval PO & SPK', route: 'dashboard', icon: '✍️' },
            ...
            case 6: // KEU_KANTOR
                return [
                    ...
                    { name: 'Eksekusi Pembayaran', route: 'dashboard', icon: '💸' },
                ];
            case 7: // PAJAK
                return [
...
file_put_contents($layoutFile, $layoutCode);
echo "Updated AuthenticatedLayout.jsx\n";
