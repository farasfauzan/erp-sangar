...
class CreateGorontaloSpkGrSeeder extends Seeder
{
    public function run(): void
    {
        $this->command->info("Creating SPKs and Goods Receipts for Gorontalo...");
        ...
        $this->command->info('SPKs and Goods Receipts created!');
    }
}