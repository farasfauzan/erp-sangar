...
export const CREDENTIALS = {
  ...
  purchasing: { email: 'purchasing@erp.com', password: 'password', roleName: 'PURCHASING_LEGAL' },
  verifikator: { email: 'verifikator@erp.com', password: 'password', roleName: 'VERIFIKATOR_KEU' },
  mgr_komersial: { email: 'mgr@erp.com', password: 'password', roleName: 'MGR_KOMERSIAL' },
  keu_kantor: { email: 'keu@erp.com', password: 'password', roleName: 'KEU_KANTOR' },
